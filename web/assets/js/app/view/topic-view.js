...
TopicView.cleanTopicForm = function() {
    $('slector ami kiválasztja az elemt').find('input selectora, texarea selectora').val(''); //TODO órán példakód volt.
};

TopicView.clearValidationErrors = function () {
    // TODO
};

TopicView.renderValidationErrors = function (validationErrors) {
    // TODO
};